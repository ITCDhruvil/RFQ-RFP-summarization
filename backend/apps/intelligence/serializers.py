...
from apps.intelligence.models import DocumentChunk, ExtractedInsight, GeneratedCommercialProposal, GeneratedProposal, GeneratedSummary
...
class ProposalStatusSerializer(serializers.Serializer):
    document_id = serializers.UUIDField()
    proposal_status = serializers.CharField(allow_null=True)
    proposal_id = serializers.UUIDField(allow_null=True)
    version = serializers.IntegerField(allow_null=True)
    total_tokens = serializers.IntegerField(allow_null=True)
    error_message = serializers.CharField(allow_null=True, required=False)
    summary_status = serializers.CharField(allow_null=True)
...
class GeneratedCommercialProposalSerializer(serializers.ModelSerializer):
    document_id = serializers.UUIDField(source="document.id", read_only=True)

    class Meta:
        model = GeneratedCommercialProposal
        fields = (
            "id",
            "document_id",
            "status",
...
class CommercialProposalStatusSerializer(serializers.Serializer):
    document_id = serializers.UUIDField()
    commercial_proposal_status = serializers.CharField(allow_null=True)
    commercial_proposal_id = serializers.UUIDField(allow_null=True)
    version = serializers.IntegerField(allow_null=True)
    total_tokens = serializers.IntegerField(allow_null=True)
    error_message = serializers.CharField(allow_null=True, required=False)
    summary_status = serializers.CharField(allow_null=True)
