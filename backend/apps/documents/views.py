...
class DocumentDetailView(RetrieveDestroyAPIView):
    ...
    def get_object(self):
        return DocumentService.get_document(self.kwargs["document_id"])

    def perform_destroy(self, instance):
        DocumentService.delete_document(instance.id)
...
class TenderDetailView(RetrieveAPIView):
    ...
    def get_object(self):
        return TenderService.get_tender(self.kwargs["tender_id"])
